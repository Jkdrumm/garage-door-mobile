...
export interface ClientEmitMutations {
  CHECK_FOR_NEW_VERSION: (
    ack: (
      data: SocketReturnValue<{version: string; timeOfLastCheck: string}>,
    ) => void,
  ) => void;
